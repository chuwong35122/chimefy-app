...
<div class="mt-20">
	...
	<div class="w-full p-4 rounded-xl bg-black grid grid-cols-4 gap-4">
		{#each participants as member}
			<div class="grid place-items-center relative group">
				<div
					class="w-32 h-32 rounded-full absolute top-0 bg-gradient-to-b from-dark-400/40 to-white/30 grid place-items-center hover:from-dark-400/0 hover:to-white/0 duration-300"
				>
				...
				/>
				<p class="mt-2">{member?.spotifyDisplayedName}</p>
			</div>
		{/each}
	</div>
  <div class="h-12" />
