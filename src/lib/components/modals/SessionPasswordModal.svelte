	...
	<form class="grid place-items-center" on:submit|preventDefault={enterSession}>
		...
		<ButtonGroup size="lg" class="w-96 focus:shadow-lg focus:shadow-white mb-4">
			...
			<Input
				...
				type="password"
				defaultClass="!border-dark-300 placeholder:text-dark-200 text-white border-2 w-full !bg-[rgba(255,255,255,0.05)] !border-l-0 !border-r-0 placeholder:text-[rgba(0,0,0,0.4)] !text-lg focus:border-dark-300 border-dark-300 text-black"
			/>
			<Button
				type="submit"
				color="dark"
