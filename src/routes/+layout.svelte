...
<Modal bind:open={showSpotifyLoginModal} size='md'>
  <div class="w-96">
      ...
      <div class="grid place-items-center mt-6">
				<a href={redirectToSpotifyAuth()} class='flex flex-row justify-center items-center hover:opacity-95 hover:scale-105 bg-dark-500 rounded-full duration-200 p-2 w-64'>
					<!-- <p class='text-3xl font-semibold text-white mr-4'>Go to</p> -->
